...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*AddVehicleRequest)(nil), // 3: user.v1.AddVehicleRequest
	(*UserRequest)(nil),       // 4: user.v1.UserRequest
	(*VehicleList)(nil),       // 5: user.v1.VehicleList
	(*Empty)(nil),             // 6: user.v1.Empty
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	3, // 2: user.v1.UserService.AddVehicle:input_type -> user.v1.AddVehicleRequest
	4, // 3: user.v1.UserService.GetVehicles:input_type -> user.v1.UserRequest
	2, // 4: user.v1.UserService.Register:output_type -> user.v1.UserResponse
	2, // 5: user.v1.UserService.Login:output_type -> user.v1.UserResponse
	6, // 6: user.v1.UserService.AddVehicle:output_type -> user.v1.Empty
	5, // 7: user.v1.UserService.GetVehicles:output_type -> user.v1.VehicleList
